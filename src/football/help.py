...
SECTIONS: list[Section] = [
    ...
    Section(
        ...
        entries=[
            ...
            ("football clubs --coverage", "Timeline strip for every imported club."),
            ...
            ("football coverage --club <name>", "One club's gaps. Fuzzy: \"albion\" offers a choice."),
    ...
    Section(
        ...
        entries=[
            ...
            ("football collect", "Fetch and import a club from every source."),
